...
@Component({
  selector: 'app-notifications-archive',
  templateUrl: './notifications-archive.component.html',
  styleUrls: ['./notifications-archive.component.css']
})
export class NotificationsArchiveComponent {
