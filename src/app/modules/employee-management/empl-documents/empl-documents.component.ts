...
@Component({
  selector: 'app-empl-documents',
  templateUrl: './empl-documents.component.html',
  styleUrls: ['./empl-documents.component.css'],
  animations : [grooveState, dongleState]
})
export class EmplDocumentsComponent {
