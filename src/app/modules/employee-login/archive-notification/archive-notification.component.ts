...
@Component({
  selector: 'app-archive-notification',
  templateUrl: './archive-notification.component.html',
  styleUrls: ['./archive-notification.component.css']
})
export class ArchiveNotificationComponent {
showSidebar: boolean = false;
  ...
  ngOnInit() {
    ...
    let actionType = 'm2h8+KCuhEPLUsv9LDUtNOwPVI7rOd111u2gg4uo+a8=';
    this.Notification_Alert(actionType);
  }
  ...
  Notification_Alert(actionType = 'm2h8+KCuhEPLUsv9LDUtNOwPVI7rOd111u2gg4uo+a8=') {
    this.helpAndSupportService.getTpAlertsByDateFilter({
      "actionType": actionType,
      "emp_id": this._EncrypterService.aesEncrypt(this.decoded_token.employee_flag.js_id?.toString()),
