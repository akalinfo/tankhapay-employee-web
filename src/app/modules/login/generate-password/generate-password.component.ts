...
export class GeneratePasswordComponent {
  ...
  Reset_Password() {
    ...
    if (this.postData.newpassword == '') {
      ...
      this.AlertService.error('Please enter your new password', GlobalConstants.alert_options);
      return;
    }

    if (this.postData.confirmpassword == '') {
      // this.toastr.error('Please enter your Confirm password', 'Oops');
      this.AlertService.error('Please enter your Confirm password', GlobalConstants.alert_options);
      return;
    }
    ...
    if (this.postData.newpassword != this.postData.confirmpassword) {
      ...
      this.AlertService.error('New password and confirm password do not match', GlobalConstants.alert_options);
      return;
    }
